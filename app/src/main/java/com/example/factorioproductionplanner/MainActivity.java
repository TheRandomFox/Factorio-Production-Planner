...
public class MainActivity extends AppCompatActivity
{
    ...
    List productList = Products.loadProductList();
    
    /*
    Method: 'View Recipe list' button
    From this activity, go to ViewAllRecipesActivity.
    */
    public void onViewRecipesButtonClick(View view)
    {
        Intent viewRecipes = new Intent(this, ViewAllRecipesActivity.class);
